...
public class GradeCalculator {
    public static void main(String[] args) {
        ...
        System.out.println("Total number of C: " + gradeOfB.size());
        System.out.println("Total number of D: " + gradeOfB.size());
        System.out.println("Total number of F: " + gradeOfB.size());
