...
public class MyScrumTeam {
    public static void main(String[] args) {
        ...
        Tester tester3 = new Tester("Lila",34,"SE",135000);
        ...
        Developer developer2= new Developer("Aynur",38,"Java Master",185000);
        Developer developer3= new Developer("Tunc",28,"software Developer",135000);
        Developer developer4= new Developer("Oliver",34,"Senior Developer",200000);

        Developer[]developers = {developer2,developer3,developer4};
        // 1 ScrumTeam objects
        ScrumTeam scrum = new ScrumTeam("peri","nadi","Ali",14);
