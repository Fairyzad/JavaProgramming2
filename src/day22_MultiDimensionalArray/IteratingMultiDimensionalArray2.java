...
public class IteratingMultiDimensionalArray2 {
    public static void main(String[] args) {
        ...
        for (int i = arr2D.length - 1; i >= 0; i--) {// i : index number of 1D arrays starting from last index to 0
            ...
            System.out.println();  //  for appended a new line

        }
        System.out.println("------------------------------------------------");

        for (int i = 0; i < arr2D.length; i++) {//i: index number of 1D arrays starting from  0
            for (int j = arr2D.length - 1; j >= 0; j--) { //j: index number of elements starting from last index
