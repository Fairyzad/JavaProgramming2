...
//                     given the new name with parameter
    public void setName(String name){// instance method, it just needs to reassign
        this.name = name;
    }
    ...
    //                   new age
    public void setAge(int age ){// parameters return type must be same as your private variable type
        if(age < 5 || age > 90){
           return; // the method is void so return statement does not return any value. exsit the method.
        }
        this.age=age;
    ...
    public void setSchoolName(String schoolName) { // setter and getter only use for private field
